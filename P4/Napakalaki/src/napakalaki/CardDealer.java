...
public class CardDealer {
    ...
    public void initMonsterCardDeck(){
        ...
        pz=new Prize(3,1);
        unusedMonsters.add(new Monster("El mal indecible impronunciable", 10, bc, pz,-2));
        
        /////////////////////////////////////////////////////////////////////
       
        bc=new NumericBadConsequence("Pierde tus tesoros visibles. Jajaja", 0, 2,0);
        pz=new Prize(2,1);
        unusedMonsters.add(new Monster("Testigos Oculares", 6, bc, pz, 2));
        
        /////////////////////////////////////////////////////////////////////
        
        bc=new DeathBadConsequence("Hoy no es tu dia de suerte. Mueres", 0, true);
        pz=new Prize(2,5);
        unusedMonsters.add(new Monster("El gran cthulhu", 20, bc, pz, 4));   
        
        /////////////////////////////////////////////////////////////////////
        
        bc=new NumericBadConsequence("Tu gobierno te recorta 2 niveles", 2, 0,0);
        pz=new Prize(2,1);
        unusedMonsters.add(new Monster("Serpiente Político", 8, bc, pz, -2)); 
        ...
        pz=new Prize(1,1);
        unusedMonsters.add(new Monster("Felpuggoth", 2, bc, pz, 5)); 
        
        /////////////////////////////////////////////////////////////////////
        
        bc=new NumericBadConsequence("Pierdes 2 niveles", 2, 0, 0);
        pz=new Prize(4,2);
        unusedMonsters.add(new Monster("Shoggoth", 16, bc, pz, -4)); 
        
        /////////////////////////////////////////////////////////////////////
        
        bc=new NumericBadConsequence("Pintalabios negro. Pierdes 2 niveles", 2, 0, 0);
        pz=new Prize(1,1);
        unusedMonsters.add(new Monster("Shoggoth", 2, bc, pz, 3));        
    }
