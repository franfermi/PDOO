...
public class PruebaNapakalaki {
    ...
    ArrayList<Monster> Mayor10(ArrayList<Monster> monstruos)
    {
        ArrayList<Monster> nuevomonstruo=new ArrayList();
        
        for (Monster monstruo1 : monstruos)
        {
            if (monstruo1.getCombatLevel() > 10 )
                nuevomonstruo.add(monstruo1);   
        }
        return nuevomonstruo;
    }
    
    ArrayList<Monster> PerdidaTesoros(ArrayList<Monster> monstruos)        
    {
        ArrayList<Monster> nuevomonstruo=new ArrayList();
        
        for(Monster monst: monstruos)
        {
            if(monst.getBc().getnHiddenTreasures() > 0 || monst.getBc().getnVisibleTreasures() > 0)
               nuevomonstruo.add(monst);
        }
        return nuevomonstruo;
    }
    
    ArrayList<Monster> GananciaNivel(ArrayList<Monster> monstruos)            
    {
        ArrayList<Monster> nuevomonstruo=new ArrayList();
        
        for(Monster monst: monstruos)
        {
            if( monst.getPc().getLevel() > 1)
               nuevomonstruo.add(monst);
        }       
        return nuevomonstruo;
    }
    ...
    ArrayList<Monster> SoloPerdidaNivel(ArrayList<Monster> monstruos)            
    {
        ArrayList<Monster> nuevomonstruo=new ArrayList();
        
        for(Monster monst: monstruos)
        {
            if( monst.getBc().getnHiddenTreasures()==0 &&  monst.getBc().getnVisibleTreasures()==0 && monst.getBc().getLevels() > 0)
               nuevomonstruo.add(monst);
        }        
        return nuevomonstruo;
    }
    ...
    public static void main(String[] args) {
        ...
        prize = new Prize(1, 1);
        monstruos.add(new Monster("Chimithulhu", 2, badConsequence, prize));
        /////////////////////////////////////////////////////
        ...
        /////////////////////////////////////////////////////
        badConsequence = new BadConsequence("Pierdes todos tus tesoros visibles.", 0, 3, 0);
        prize = new Prize(3, 1);
        ...
        /////////////////////////////////////////////////////
        badConsequence = new BadConsequence("Sientes bichos bajo la ropa.", 0, 
                new ArrayList(Arrays.asList(TreasureKind.ARMOR)), null);
        prize = new Prize(1, 1);
        ...
        badConsequence = new BadConsequence("La quinta directiva primaria te obliga a perder 2 niveles y un tesoro 2 manos visible.",
                2, new ArrayList(Arrays.asList(TreasureKind.BOTHHANS)), null);
        prize = new Prize(2, 1);
        ...
        badConsequence = new BadConsequence("Te faltan manos para tanta cabeza. Pierdes 3 niveles y tus tesoros visibles de las manos",
                3, new ArrayList(Arrays.asList(TreasureKind.BOTHHANS)), null);
        prize = new Prize(1, 1);
